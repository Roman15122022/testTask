...
export class Hud {
    constructor(onControlToggle) {
        ...
        Object.defineProperty(this, "herdText", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.view.addChild(background, divider, this.scoreText, this.statusText, this.herdText, this.controlButton.view);
    }
    update(score, herdSize, herdLimit, status) {
